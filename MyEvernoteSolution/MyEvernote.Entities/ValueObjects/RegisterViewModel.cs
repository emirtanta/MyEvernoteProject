...
namespace MyEvernote.Entities.ValueObjects
{
    public class RegisterViewModel
    {
        ...
        [DisplayName("E-posta"), Required(ErrorMessage = "{0} alanı boş geçilemez"), StringLength(25, ErrorMessage = "{0} max {1} karakter olmalı"),EmailAddress(ErrorMessage ="{0} alanı için bir e-posta adresi giriniz")]
